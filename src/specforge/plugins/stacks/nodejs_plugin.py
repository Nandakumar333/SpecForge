"""NodejsPlugin — Node.js stack plugin with architecture-aware rules."""
...
from specforge.plugins.stacks.nodejs_rules import (
...
class NodejsPlugin(StackPlugin):
    """Node.js stack plugin providing architecture-specific governance rules."""
    ...
    def description(self) -> str:
        return (
            "Node.js stack plugin with architecture-aware governance "
    ...
    def _microservice_folders(self) -> dict[str, str]:
        return {
            ...
            "packages/shared/": "Shared libraries and contracts",
